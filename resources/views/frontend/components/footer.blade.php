        ...
        <div class="mid">
            ...
            <div class="wImage htch">
                <a href="/he-thong-cua-hang/" title="Hệ thống cửa hàng" class="image cover">
                    <img data-src="https://www.dangquangwatch.vn/view/Pic/cua-hang-dang-quang.jpg" class="lazyload" alt="Dang Quang Watch" src="https://www.dangquangwatch.vn/view/Css/icon/thumnail.jpg"/>
                </a>
        ...
        <div class="right">
            ...
            <div class="wImage htch">
                <a href="https://www.facebook.com/donghodangquang/" title="" target="_blank" class="image cover">
                    <img data-src="https://www.dangquangwatch.vn/view/Css/icon/facebook-fanpage-donghodangquang.jpg" class="lazyload" alt="Dang Quang Watch" src="https://www.dangquangwatch.vn/view/Css/icon/thumnail.jpg"/>
                </a>
            </div>
        </div>
    </div>
...
<div id="commonBot">
    <div class="wrp">
        <a href="/" title="" class="logo">
            <img data-src="https://www.dangquangwatch.vn/view/Css/icon/Logo.png" class="lazyload" alt="Dang Quang Watch" src="https://www.dangquangwatch.vn/view/Css/icon/thumnail.jpg"/>
        </a>
        <div class="right">
...
<input type="hidden" name="pro_link" id="pro_link" value="">
<input type="hidden" name="pro_id" id="pro_id" value="">
<input type="hidden" name="pro_listid" id="pro_listid" value="">
<div style="display: none" id="other_cart"></div>
<input type="hidden" name="tran_id" id="tran_id" value="">
<div id="overlay"></div>
<input type="hidden" name="TenMienWebSite" id="TenMienWebSite" value="https://www.dangquangwatch.vn"/>
