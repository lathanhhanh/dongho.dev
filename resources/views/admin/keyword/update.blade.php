    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Cập nhật từ khoá</h3>
            </div>
            <!-- /.card-header -->
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->first('k_name') ? 'is-invalid' : '' }}" name="k_name" placeholder="Keyword..." value="{{ $keyword->k_name }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control {{ $errors->first('k_description') ? 'is-invalid' : '' }}" name="k_description" placeholder="Description...">{{ $keyword->k_description }}</textarea>
